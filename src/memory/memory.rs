...
impl Memory {
    ...
    pub fn read8(&self, addr: u16) -> u8 {
        match addr {
            ...
            0x8000...0xFFFF if self.mapper == 0 => 0, // prg_rom[addr as usize - 0x8000]
            0x8000...0xFFFF if self.mapper == 1 => 0, // prg_rom[addr as usize]
...
mod tests {
    ...
    fn wraps_correctly() {
        let mut mem = Memory::new(0);
        (0x000_u16..0x0800_u16).for_each(|i| assert_eq!(0_u8, mem.read8(i)));
        (0x800_u16..0x1000_u16).for_each(|i| mem.write8(i, 1_u8));
        (0x000_u16..0x0800_u16).for_each(|i| assert_eq!(1_u8, mem.read8(i)));
    }
}